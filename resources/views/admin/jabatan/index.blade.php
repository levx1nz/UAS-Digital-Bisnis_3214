            ...
            <tr class="hover:bg-slate-50">
                ...
                <td class="p-4 border-b">
                    <div class="flex justify-end gap-2">
                        <a href="{{ route('admin.jabatan.edit', $item->id) }}" title="Edit" class="p-2.5 bg-indigo-50 text-indigo-600 rounded-xl hover:bg-indigo-600 hover:text-white transition">
